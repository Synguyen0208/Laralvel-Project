(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Admin_pages_DonatorPage_js"],{
...
/***/ "./resources/js/Admin/pages/DonatorPage.js":
/*!*************************************************!*\
  !*** ./resources/js/Admin/pages/DonatorPage.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var DonatorPage = /*#__PURE__*/function (_React$Component) {
  ...
  function DonatorPage(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getData", function () {
      _this.call.callAPI('donator', 'get', '').then(function (response) {
        _this.setState({
          data: response.data
        });
      });
