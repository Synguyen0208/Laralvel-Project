                        ...
                        {this.props.data.map(value1 => {
                            return (<tr>
                                {Object.values(value1).map((value, key) => {
                                    if (keye[key] == "image")
                                        return <td><img style={{ width: "5rem", height: "5rem" }} src={'../images/' + value}></img></td>
                                    else if (keye[key] == "description" && value != '')
                                        return <td>
                                    ...
                                    <div class="row">
                                        {this.props.update != undefined &&
                                            <p data-placement="top" data-toggle="tooltip" title="Edit">
                                                <button type="button" class="btn btn-success" onClick={() => { this.props.update('update', 'Update Staff', value1) }}>
                                        ...
                                        }
                                        {
                                            ...
                                            <p data-placement="top" data-toggle="tooltip" title="Edit">
                                                <button onClick={() => this.props.delete('delete', 'Delete Staff', value1.id)} type="button" class="btn btn-outline-danger" >
