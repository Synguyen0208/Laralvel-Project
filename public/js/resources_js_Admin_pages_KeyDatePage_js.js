(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Admin_pages_KeyDatePage_js"],{
...
/***/ "./resources/js/Admin/pages/KeyDatePage.js":
/*!*************************************************!*\
  !*** ./resources/js/Admin/pages/KeyDatePage.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var KeyDatePage = /*#__PURE__*/function (_React$Component) {
  _inherits(KeyDatePage, _React$Component);

  var _super = _createSuper(KeyDatePage);

  function KeyDatePage(props) {
    var _this;

    _classCallCheck(this, KeyDatePage);
    ...
    _defineProperty(_assertThisInitialized(_this), "createFormData", function () {
      ...
      form.append('timeline', _this.state.timeline);
      form.append('description', document.getElementById('description').value);
      form.append('country_id', _this.state.country_id);
      return form;
    });

    _defineProperty(_assertThisInitialized(_this), "addEvent", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _this.call.callAPI('keydate', 'post', form).then(function (response) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateEvent", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                form = _this.createFormData();
                _context2.next = 4;
                return _this.call.callAPI('updateKeyDate/' + _this.state.id, 'post', form).then(function (response) {
    ...
    _defineProperty(_assertThisInitialized(_this), "deleteEvent", function (id) {
      _this.call.callAPI('keydate/' + id, 'delete', '').then(function (response) {
        if (response.data.err == 0) {
          _this.notificationSystem.addNotification({
            title: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_icons_md__WEBPACK_IMPORTED_MODULE_11__.MdLoyalty, {}),
            message: response.data.message,
  ...
  _createClass(KeyDatePage, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_Page__WEBPACK_IMPORTED_MODULE_1__.default, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_12__.default, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_13__.default, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_14__.default, {
              onClick: function onClick() {
                return _this2.open('add', 'Add Key Date');
              },
              outline: true,
              color: "primary",
              children: "Add Key Date"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (KeyDatePage);
